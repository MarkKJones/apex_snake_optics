...
#include <TPolyLine.h>
#include <TLegend.h>
void make_hrs_hist_ver2(TString fstart) {
  gROOT->Reset();
  gStyle->SetOptStat(0);
 ...
 //  TString fstart="hrs_q1mod30_sieveran_traj_15cm_20deg";
 //  TString fstart="hrs_q1mod30_ran_traj_15cm_40deg";
 //  TString fstart="hrs_standard_ran_traj_foils_20deg";
 //         TString fstart="apex_ran_traj_20deg" ;
 //    fstart="hrs_ran_traj_20deg" ;
       //       TString fstart="hrs_standard_ran_traj_15cm_40deg";
 Double_t cmom=0.837595,delta,ytar,ztemp,thcent=40./180.*3.14159;
...
//   string oldcoeffsfilename="hms_newfit_hrs_standard.dat";
 //     string oldcoeffsfilename="hrs_mod62_fullmatrix_foils_40deg.dat";
  //   string oldcoeffsfilename="hrs_mod62_fullmatrix_foils_20deg.dat";
 //   string oldcoeffsfilename="hrs_newfit_mod30_2ndord_40degtest_fit.dat";
 // string oldcoeffsfilename="hms_newfit_hrs_mod20.dat";
    //      string oldcoeffsfilename="hms_newfit_hrs_mod30_ver1.dat";
...
Double_t evnum,epnum,xabs,yabs,zabs,cxabs,cyabs,czabs,mom,pathl,live,xrel,yrel,zrel,cxrel,cyrel,czrel;
 ...
 TH2F *hxyfp = new TH2F("hxyfp","xfp vs yfp (cm)",40,-10.,10.,100,-100.,100.);
...
,+80.,+80.,+80.,+80.,+80.,+80.
 ...
 TString EndPlname[NumEndPl]={"Target"," 80.0cm from target"," Collimnator",
 ...
 int nfit=0;
      nentries = (int)tsnake->GetEntries();
           for (int ie = 0; ie < nentries; ie++)
            {
	      if (ie%1000==0)    	      cout << ie << " nfit = " << nfit << endl;
	         tsnake->GetEntry(ie);
   	  delta=(mom-cmom)/cmom;
          EndPl = epnum;
          if ( EndPl > NumEndPl) {
