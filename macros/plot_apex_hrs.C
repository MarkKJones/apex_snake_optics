...
#include <TPolyLine.h>
#include <TLegend.h>
void plot_apex_hrs(TString fstart) {
  gROOT->Reset();
  gStyle->SetOptStat(0);
...
TFile *hsnake = new TFile("rootfiles/"+fstart+"_standard_hist.root","recreate");
 Bool_t fit_matrix=kTRUE;
   string newcoeffsfilename="matrix-files/hms_newfit6_save.dat";
 TRandom3 err; 
//
  string oldcoeffsfilename="matrix-files/hms_newfit_1104setting.dat";
